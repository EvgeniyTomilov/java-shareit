...
import ru.practicum.shariet.item.dto.CommentRequestDtoGateway;
import ru.practicum.shariet.item.dto.ItemDto;
import ru.practicum.shariet.item.dto.ItemDtoGateway;
...
public class ItemController {
    ...
    public ResponseEntity<Object> addComment(@Positive @RequestHeader(SHARER_USER_ID) Long authorId,
    ...
    @PostMapping
    public ResponseEntity<Object> add(@Positive @RequestHeader(SHARER_USER_ID) Long ownerId,
    ...
    @PatchMapping("/{itemId}")
    public ResponseEntity<Object> update(@Positive @RequestHeader(SHARER_USER_ID) Long userId,
                                         @Positive @PathVariable Long itemId,
    ...
    @GetMapping
    public ResponseEntity<Object> getItems(@Positive @RequestHeader(SHARER_USER_ID) Long ownerId) {
    ...
    @GetMapping("/{itemId}")
    public ResponseEntity<Object> getItem(@Positive @RequestHeader(SHARER_USER_ID) Long userId,
                                          @Positive @PathVariable Long itemId) {
    ...
    public void deleteItem(@Positive @RequestHeader(SHARER_USER_ID) Long userId,
                           @Positive @PathVariable Long itemId) {
